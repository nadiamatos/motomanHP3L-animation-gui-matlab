function Jm = jacobianHP3L(t)
    % calcula o Jacobiano a partir das expressões abaixo e usando os
    % angulos em t, angulos em graus.
    
    % obs: singularidade quando t5 = 0.
    
    % parâmetros específicos do manipulador.
    a2 = 100; a3 = 370; a4 = 85;
    d1 = 300; d2 = 170; d4 = 191.5; d5 = 380-d4; d6 = 90;
    
    t1 = (t(1)*pi)/180; t2 = (t(2)*pi)/180; t3 = (t(3)*pi)/180;
    t4 = (t(4)*pi)/180; t5 = (t(5)*pi)/180; % t6 = (t(6)*pi)/180;
